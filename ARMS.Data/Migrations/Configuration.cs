namespace ARMS.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ARMS.Data.ArmsContext>
    {
        ...
        protected override void Seed(ARMS.Data.ArmsContext context)
        {
            ...
            //    new Student() { ID = 1, FirstName = "Aleksandar", LastName = "Stoyanov", Email = "alex_d97@abv.bg", Username = "asddsaasd51" },
            //    new Student() { ID = 2, FirstName = "Johnny", LastName = "Pit", Email = "exmp1@exm.com", Username = "asddsaasd5" },
            //    new Student() { ID = 3, FirstName = "Bradd", LastName = "Depp", Email = "exmp2@exm.com", Username = "asddsaasd7" }
            //    );

            //context.Teachers.AddOrUpdate(x => x.ID,
            //    new Teacher() { ID = 1, FirstName = "Alex", LastName = "Dinev", Email = "alex_d97@abv.bg", Username = "asddsaasd145" },
            //    new Teacher() { ID = 2, FirstName = "Kim", LastName = "Nielsen", Email = "exmp1@exm.com", Username = "asddsaasd2" },
            //    new Teacher() { ID = 3, FirstName = "Ole", LastName = "Google", Email = "exmp2@exm.com", Username = "asddsaasd3" }
            //    );
            ...
            //context.Lectures.AddOrUpdate(x => x.CourseID,
